...
## [0.0.36](https://github.com/JasonBuildAI/deepagents/compare/deepagents-cli==0.0.35...deepagents-cli==0.0.36) (2026-04-08)


### Features

* **cli:** `--json` flag for machine-readable output ([#1768](https://github.com/JasonBuildAI/deepagents/issues/1768)) ([6f62496](https://github.com/JasonBuildAI/deepagents/commit/6f62496bb699dfa6086ee1850b83f38d3b1242fa))
* **cli:** `--skill` startup invocation ([#2477](https://github.com/JasonBuildAI/deepagents/issues/2477)) ([5f0f1d4](https://github.com/JasonBuildAI/deepagents/commit/5f0f1d4605de1f1545846e2dbcc29a24c6f138d7))
* **cli:** `/auto-update` to toggle auto-updates ([#2276](https://github.com/JasonBuildAI/deepagents/issues/2276)) ([ad70bde](https://github.com/JasonBuildAI/deepagents/commit/ad70bde070c58057ff98871fcacd95f03487051e))
* **cli:** add `-y` and `-S` short flags for auto-approve and shell-allow-list ([#1919](https://github.com/JasonBuildAI/deepagents/issues/1919)) ([1036b16](https://github.com/JasonBuildAI/deepagents/commit/1036b16276d59d8be669d963901c91aeb8cc2236))
* **cli:** add `DEEPAGENTS_CLI_` env var prefix and fix dotenv load order ([#2303](https://github.com/JasonBuildAI/deepagents/issues/2303)) ([29647bb](https://github.com/JasonBuildAI/deepagents/commit/29647bb4cdd89a1de65f6adb518f708135d59e03))
* **cli:** add `enabled` flag to hide providers from `/model` switcher ([#1897](https://github.com/JasonBuildAI/deepagents/issues/1897)) ([72a216c](https://github.com/JasonBuildAI/deepagents/commit/72a216c88f661f9e53eaf92aedce40fac7b76d3c))
* **cli:** add `litellm` optional dep ([#1818](https://github.com/JasonBuildAI/deepagents/issues/1818)) ([defa21b](https://github.com/JasonBuildAI/deepagents/commit/defa21bc6eea596bc67e70372e022d5b78049c0d))
* **cli:** add `ls_integration` metadata to langsmith traces ([#2272](https://github.com/JasonBuildAI/deepagents/issues/2272)) ([5dd8098](https://github.com/JasonBuildAI/deepagents/commit/5dd80983a57a5c48bb9c75c6760733882cb908c2))
* **cli:** add `sessions` as hidden keyword alias for `/threads` ([#1823](https://github.com/JasonBuildAI/deepagents/issues/1823)) ([ffa98cc](https://github.com/JasonBuildAI/deepagents/commit/ffa98ccf9ebe12eadb7f0e95f278dd9bd8eca240))
* **cli:** add animated spinner to non-interactive verbose mode ([#2001](https://github.com/JasonBuildAI/deepagents/issues/2001)) ([153f465](https://github.com/JasonBuildAI/deepagents/commit/153f465937c09a792119a0e0c8656fa8df29d4e5))
* **cli:** add async backend support to local context middleware ([#2118](https://github.com/JasonBuildAI/deepagents/issues/2118)) ([a0d623c](https://github.com/JasonBuildAI/deepagents/commit/a0d623cf18d216b5de36cc7d40e7804d5cc4dfa3))
* **cli:** add baseten as a model provider ([#1819](https://github.com/JasonBuildAI/deepagents/issues/1819)) ([e05ee66](https://github.com/JasonBuildAI/deepagents/commit/e05ee66b0d6c5cb996208d554686fc128f1094a2))
* **cli:** add external editor support via `ctrl+x` and `/editor` ([#1861](https://github.com/JasonBuildAI/deepagents/issues/1861)) ([bf5d088](https://github.com/JasonBuildAI/deepagents/commit/bf5d088d4b3cee6c7e44c3abe3736f9972897896))
* **cli:** add rotating tips to welcome banner ([#1898](https://github.com/JasonBuildAI/deepagents/issues/1898)) ([d882ca8](https://github.com/JasonBuildAI/deepagents/commit/d882ca81e2c9a11768a07824fd5b5ce8579bdcd7))
* **cli:** add sandbox type to trace metadata ([#1845](https://github.com/JasonBuildAI/deepagents/issues/1845)) ([59ef941](https://github.com/JasonBuildAI/deepagents/commit/59ef94143fc0adabb5f70f308527d98aa1511e44))
* **cli:** add token breakdown to `/tokens` and simplify `/compact` messages ([#1782](https://github.com/JasonBuildAI/deepagents/issues/1782)) ([2f37bff](https://github.com/JasonBuildAI/deepagents/commit/2f37bffa9d7a9ced6945abe4ab6bc3409bfb97b1))
* **cli:** agent-friendly ux for scripted/headless workflows ([#2271](https://github.com/JasonBuildAI/deepagents/issues/2271)) ([386438f](https://github.com/JasonBuildAI/deepagents/commit/386438f62a458baa367468cf746c3a5387a217d4))
* **cli:** AgentCore Code Interpreter sandbox provider ([#2120](https://github.com/JasonBuildAI/deepagents/issues/2120)) ([92556c7](https://github.com/JasonBuildAI/deepagents/commit/92556c767aaab601d3ea753baf7f52642e5769a4))
* **cli:** allow color overrides on built-in themes, default dark to false ([#2275](https://github.com/JasonBuildAI/deepagents/issues/2275)) ([8f71865](https://github.com/JasonBuildAI/deepagents/commit/8f718650ee1913f83e70aa7854e576edc816e694))
* **cli:** auto-update lifecycle, `/update` command, install script ux ([#2095](https://github.com/JasonBuildAI/deepagents/issues/2095)) ([fd92f6e](https://github.com/JasonBuildAI/deepagents/commit/fd92f6eaa87bb1a397f1b7fd216657f354c46e0f))
* **cli:** client-server architecture via `langgraph dev` ([#1759](https://github.com/JasonBuildAI/deepagents/issues/1759)) ([f5407e6](https://github.com/JasonBuildAI/deepagents/commit/f5407e6300e6ee51d8c88f1f183dd960b30a5b56))
* **cli:** context-aware connecting banner for resume and local server ([#2092](https://github.com/JasonBuildAI/deepagents/issues/2092)) ([18b385b](https://github.com/JasonBuildAI/deepagents/commit/18b385be979d461797a76b6d7217e259fe260b2c))
* **cli:** default langsmith project to `'deepagents-cli'` ([#2277](https://github.com/JasonBuildAI/deepagents/issues/2277)) ([7178b87](https://github.com/JasonBuildAI/deepagents/commit/7178b8729a03ee1e5508fdf6c111488d18e77e8f))
* **cli:** defer HITL approval menu while user is typing ([#1833](https://github.com/JasonBuildAI/deepagents/issues/1833)) ([1d1572e](https://github.com/JasonBuildAI/deepagents/commit/1d1572e40cc9f87b97832cbe2b9152c281f8ec92))
* **cli:** enable `ask_user` tool by default ([#1830](https://github.com/JasonBuildAI/deepagents/issues/1830)) ([ed0c745](https://github.com/JasonBuildAI/deepagents/commit/ed0c745eef8d8fad40aa39b0dfd4de2ba9988fe5))
* **cli:** enhance tool-call UI, add `Ctrl+U` shortcut for chat input ([#1757](https://github.com/JasonBuildAI/deepagents/issues/1757)) ([800c552](https://github.com/JasonBuildAI/deepagents/commit/800c55213aa4c6515759fb70d36af370feb86302))
* **cli:** load `~/.deepagents/.env` as global dotenv ([#1909](https://github.com/JasonBuildAI/deepagents/issues/1909)) ([5a21d0a](https://github.com/JasonBuildAI/deepagents/commit/5a21d0add1d2a885c6cd3cf36621d1da690c8db3))
* **cli:** persist token count in graph state across sessions ([#2323](https://github.com/JasonBuildAI/deepagents/issues/2323)) ([5be352d](https://github.com/JasonBuildAI/deepagents/commit/5be352d8bb4d266758f3e934f7affbe8d42b0149))
* **cli:** pop queued messages individually on `esc` instead of clearing all ([#2089](https://github.com/JasonBuildAI/deepagents/issues/2089)) ([c76d855](https://github.com/JasonBuildAI/deepagents/commit/c76d855e4c73a448af17ade8ad54a2071f2c6bfe))
* **cli:** render ask-user questions as markdown ([#2339](https://github.com/JasonBuildAI/deepagents/issues/2339)) ([5fbb14a](https://github.com/JasonBuildAI/deepagents/commit/5fbb14a4fd6f2800aec99add1d9f32b88c1d751a))
* **cli:** show cli version in non-interactive header ([#1881](https://github.com/JasonBuildAI/deepagents/issues/1881)) ([adacc3f](https://github.com/JasonBuildAI/deepagents/commit/adacc3fd0a0f040373b8ef39032978019b5c8e5f))
* **cli:** show editable install source path in help and banner ([#1916](https://github.com/JasonBuildAI/deepagents/issues/1916)) ([4ce1cee](https://github.com/JasonBuildAI/deepagents/commit/4ce1ceebdd2e4aa6db008061519d3df1e422c2db))
* **cli:** show model status in `/model` selector ([#1820](https://github.com/JasonBuildAI/deepagents/issues/1820)) ([92ce0cf](https://github.com/JasonBuildAI/deepagents/commit/92ce0cffde6f49131541b5985bc80058ae0ad46e))
* **cli:** show platform-specific ripgrep install command in missing-tool warning ([#1997](https://github.com/JasonBuildAI/deepagents/issues/1997)) ([f000ce5](https://github.com/JasonBuildAI/deepagents/commit/f000ce58ebb6438397e8eb016b2a788a91fe5754))
* **cli:** skill invocation via `/skill:name` ([#2037](https://github.com/JasonBuildAI/deepagents/issues/2037)) ([cc8cce7](https://github.com/JasonBuildAI/deepagents/commit/cc8cce70e1d6c5f897a3cebe0388aa3d774de487))
* **cli:** support root/MDM installs ([#2346](https://github.com/JasonBuildAI/deepagents/issues/2346)) ([f618acc](https://github.com/JasonBuildAI/deepagents/commit/f618acc671ca2137df165d6f56e8a46f11c63abb))
* **cli:** surface unsupported input modalities in system prompt ([#2327](https://github.com/JasonBuildAI/deepagents/issues/2327)) ([95620e7](https://github.com/JasonBuildAI/deepagents/commit/95620e796aa6bf11f424d2f83693026fbee6be58))
* **cli:** themes ([#2134](https://github.com/JasonBuildAI/deepagents/issues/2134)) ([db67af0](https://github.com/JasonBuildAI/deepagents/commit/db67af07984b5d73711383cf717b5e3d96eac3b8))
* **cli:** warn on missing tavily key, add `/notifications` ([#2555](https://github.com/JasonBuildAI/deepagents/issues/2555)) ([3dff3ed](https://github.com/JasonBuildAI/deepagents/commit/3dff3ed6835eae9f8b420b8a73c054127faaf7d2))
* **sdk,cli:** add openrouter SDK attribution ([#2205](https://github.com/JasonBuildAI/deepagents/issues/2205)) ([2798e51](https://github.com/JasonBuildAI/deepagents/commit/2798e51fd90128ffd1a2064383db17c699805395))
* **sdk,cli:** add package version metadata to traces ([#2129](https://github.com/JasonBuildAI/deepagents/issues/2129)) ([e4a44b4](https://github.com/JasonBuildAI/deepagents/commit/e4a44b467dee1e284ebe741a0e568f2dc613e068))
* **sdk:** add async subagent middleware for remote LangGraph servers ([#1758](https://github.com/JasonBuildAI/deepagents/issues/1758)) ([0c5d501](https://github.com/JasonBuildAI/deepagents/commit/0c5d501066e7e9cb74737740d9b3c1dfc74751a6))
* **sdk:** add factory function for summarization tool middleware ([#1749](https://github.com/JasonBuildAI/deepagents/issues/1749)) ([282b4c2](https://github.com/JasonBuildAI/deepagents/commit/282b4c209bde73632392cd8453e9c7430a9cbef3))
* **sdk:** add MemoryAgentBench evaluation suite ([#1807](https://github.com/JasonBuildAI/deepagents/issues/1807)) ([6a0763d](https://github.com/JasonBuildAI/deepagents/commit/6a0763d301b6d66813f7168abc300243e0a4d1ea))
* **sdk:** port `LangSmithSandbox` from CLI to SDK ([#1983](https://github.com/JasonBuildAI/deepagents/issues/1983)) ([dfff6e7](https://github.com/JasonBuildAI/deepagents/commit/dfff6e7d2f91c269290ab677a9bd7454bc2f4989))
* **sdk:** rename backend methods ([#1907](https://github.com/JasonBuildAI/deepagents/issues/1907)) ([7665066](https://github.com/JasonBuildAI/deepagents/commit/7665066c093c2583c4cd3bf83515b0906277306f))
* **sdk:** update backend return types for ls, glob, grep ([#1870](https://github.com/JasonBuildAI/deepagents/issues/1870)) ([23cf264](https://github.com/JasonBuildAI/deepagents/commit/23cf264d0d9784cfce8f8720b125c6ed05a2e2c3))
* **sdk:** update FileData and backend.read return type to support multimodal data ([#1869](https://github.com/JasonBuildAI/deepagents/issues/1869)) ([6fb4ede](https://github.com/JasonBuildAI/deepagents/commit/6fb4ede894fe5333ea11598468e924442b3b48a7))


### Bug Fixes

* **cli:** align headless todo guidance with non-interactive mode ([#2459](https://github.com/JasonBuildAI/deepagents/issues/2459)) ([281899b](https://github.com/JasonBuildAI/deepagents/commit/281899bf1932f959f512f94f4c2ac5d76ad32ecb))
* **cli:** auto-discover models for `class_path` providers ([#1816](https://github.com/JasonBuildAI/deepagents/issues/1816)) ([177fe0f](https://github.com/JasonBuildAI/deepagents/commit/177fe0f663926d6879aa2177b7988d45cd1e4055))
* **cli:** bump min `langchain` version ([#2138](https://github.com/JasonBuildAI/deepagents/issues/2138)) ([1b4bbe0](https://github.com/JasonBuildAI/deepagents/commit/1b4bbe0c9d76f483ee3b41cd4a9dea86ebddedcc))
* **cli:** correct model selector footer showing wrong profile after search ([#1805](https://github.com/JasonBuildAI/deepagents/issues/1805)) ([2f1d52f](https://github.com/JasonBuildAI/deepagents/commit/2f1d52f4ad65add210d6f840b1b78e62eba37195))
* **cli:** disable markup parsing for blocked-link notifications ([#2170](https://github.com/JasonBuildAI/deepagents/issues/2170)) ([15867bf](https://github.com/JasonBuildAI/deepagents/commit/15867bfaeb43b5fca31677fd06b25022aec10c8b))
* **cli:** dismiss slash command autocomplete on space ([#2478](https://github.com/JasonBuildAI/deepagents/issues/2478)) ([02e46bc](https://github.com/JasonBuildAI/deepagents/commit/02e46bc4cc470d93f5ab3ca05252ef1ffe87c3e7))
* **cli:** eliminate autocomplete popup flicker ([#2020](https://github.com/JasonBuildAI/deepagents/issues/2020)) ([4b2db1e](https://github.com/JasonBuildAI/deepagents/commit/4b2db1eab412ecfb1343fae123777f14e935fcea))
* **cli:** eliminate trace fragmentation in non-interactive mode ([#2136](https://github.com/JasonBuildAI/deepagents/issues/2136)) ([9bddc52](https://github.com/JasonBuildAI/deepagents/commit/9bddc52b572672e0564bfc4a8675e106d98116af))
* **cli:** enforce approval toggle when launched with `-y` ([#2278](https://github.com/JasonBuildAI/deepagents/issues/2278)) ([28a32b7](https://github.com/JasonBuildAI/deepagents/commit/28a32b7dfb6fd6ddb9aa443a9d0d70c33790edbd))
* **cli:** escape dynamic strings in rich markup to prevent markup injection ([#1888](https://github.com/JasonBuildAI/deepagents/issues/1888)) ([d349d10](https://github.com/JasonBuildAI/deepagents/commit/d349d1061647325fdb4ea6322254b24555abf751))
* **cli:** escape exception text in rich markup error output ([#2307](https://github.com/JasonBuildAI/deepagents/issues/2307)) ([42bccca](https://github.com/JasonBuildAI/deepagents/commit/42bccca05f1733a04ee21da6bf9924140f6e1e65))
* **cli:** escape markup in toast notifications ([#2139](https://github.com/JasonBuildAI/deepagents/issues/2139)) ([90ccc28](https://github.com/JasonBuildAI/deepagents/commit/90ccc28ace79ae6e2d60d1ccc99f612fb1fcb30e))
* **cli:** exit app on `ctrl+d` when thread list is empty ([#2270](https://github.com/JasonBuildAI/deepagents/issues/2270)) ([e859077](https://github.com/JasonBuildAI/deepagents/commit/e859077ffa7ee0423bbc7b86d5a4238798ec9c9a))
* **cli:** fail fast on missing provider credentials ([#2554](https://github.com/JasonBuildAI/deepagents/issues/2554)) ([50fb8ae](https://github.com/JasonBuildAI/deepagents/commit/50fb8aefe7e3065024e10f1d5ecd11a54d736641))
* **cli:** forward `DAYTONA_API_URL` to avoid deprecated `server_url` access ([#1844](https://github.com/JasonBuildAI/deepagents/issues/1844)) ([7d19ca8](https://github.com/JasonBuildAI/deepagents/commit/7d19ca8e6404a2ea98aac6a9d4cae7a2b529922c))
* **cli:** guard against textual cursor/document desync crash ([#2494](https://github.com/JasonBuildAI/deepagents/issues/2494)) ([c14a748](https://github.com/JasonBuildAI/deepagents/commit/c14a7483ed92428ec2241dd8254cdab9c26a6a4f))
* **cli:** harden MCP pre-flight health checks ([#2019](https://github.com/JasonBuildAI/deepagents/issues/2019)) ([2b27055](https://github.com/JasonBuildAI/deepagents/commit/2b270558fcd846f9f82ffa2bc3b56810b5851d7d))
* **cli:** human-readable duration and consistent dim styling on teardown screen ([#1995](https://github.com/JasonBuildAI/deepagents/issues/1995)) ([901a0a4](https://github.com/JasonBuildAI/deepagents/commit/901a0a400fccfafbef069d6632acb2227f0aef41))
* **cli:** isolate test history writes from real history file ([#2006](https://github.com/JasonBuildAI/deepagents/issues/2006)) ([a078257](https://github.com/JasonBuildAI/deepagents/commit/a078257ba6f9d9cae540f6eb82a0eabc92d71211))
* **cli:** let unknown providers through credential check ([#1815](https://github.com/JasonBuildAI/deepagents/issues/1815)) ([89d39de](https://github.com/JasonBuildAI/deepagents/commit/89d39ded171bf300e9b17972f18063e9157f298f))
* **cli:** mark token count as approximate after interrupted generation ([#2353](https://github.com/JasonBuildAI/deepagents/issues/2353)) ([cb9a0c7](https://github.com/JasonBuildAI/deepagents/commit/cb9a0c7ad2f9421471b4276a33beabc30588b694))
* **cli:** misleading "missing package" error when provider import fails ([#1960](https://github.com/JasonBuildAI/deepagents/issues/1960)) ([b90fbad](https://github.com/JasonBuildAI/deepagents/commit/b90fbad1335222a3b7ceb469f7f46fedec79ac61))
* **cli:** open trace in browser immediately when busy ([#2305](https://github.com/JasonBuildAI/deepagents/issues/2305)) ([b452032](https://github.com/JasonBuildAI/deepagents/commit/b452032438f83e0cca245dcabacf176cc1aa8857))
* **cli:** patch model identity in system prompt on `/model` swap ([#2024](https://github.com/JasonBuildAI/deepagents/issues/2024)) ([36aecbf](https://github.com/JasonBuildAI/deepagents/commit/36aecbf939cafb2d5914620a9e2ec890b02447a4))
* **cli:** persist models.recent on every session start ([#1802](https://github.com/JasonBuildAI/deepagents/issues/1802)) ([32aa371](https://github.com/JasonBuildAI/deepagents/commit/32aa371a371208146cc093c4e5eb7a752a74b3c9))
* **cli:** pre-flight health checks for MCP servers ([#2008](https://github.com/JasonBuildAI/deepagents/issues/2008)) ([30d60e3](https://github.com/JasonBuildAI/deepagents/commit/30d60e3866bde51a71f607fcd5cbe9dd75c5da75))
* **cli:** prevent premature thinking state with parallel subtasks ([#1858](https://github.com/JasonBuildAI/deepagents/issues/1858)) ([189104c](https://github.com/JasonBuildAI/deepagents/commit/189104c622a5fa874ad1d4be1c18e012cafd605a))
* **cli:** prevent reentrant model switching ([#1824](https://github.com/JasonBuildAI/deepagents/issues/1824)) ([09d16a8](https://github.com/JasonBuildAI/deepagents/commit/09d16a8151466fd2d82976d44d7b4e957255bcd9))
* **cli:** prevent session stats loss on mid-turn exit ([#2238](https://github.com/JasonBuildAI/deepagents/issues/2238)) ([b1807aa](https://github.com/JasonBuildAI/deepagents/commit/b1807aab78175c53a2d6f835ae30171d0f802d1c))
* **cli:** rebind toggle tool output to `ctrl+o` to unblock `cmd+right` ([#2088](https://github.com/JasonBuildAI/deepagents/issues/2088)) ([b486fe5](https://github.com/JasonBuildAI/deepagents/commit/b486fe5df5aa0efd11cdcffdbd96f433c2b127b3))
* **cli:** remove double slash in skills path template ([#1808](https://github.com/JasonBuildAI/deepagents/issues/1808)) ([2bc9620](https://github.com/JasonBuildAI/deepagents/commit/2bc962075146548f2ef4c8851bd502df9d6a1fa5))
* **cli:** remove duplicate server failure notification ([#2141](https://github.com/JasonBuildAI/deepagents/issues/2141)) ([c1cfe72](https://github.com/JasonBuildAI/deepagents/commit/c1cfe72055fd00685cc21a84540f21f4792033ab))
* **cli:** remove keybinding overrides that shadow textual built-ins ([#2084](https://github.com/JasonBuildAI/deepagents/issues/2084)) ([08fc5d0](https://github.com/JasonBuildAI/deepagents/commit/08fc5d088ca7be041ad680b87236a4f9e9c212cf))
* **cli:** replace per-chunk `scroll_end` with anchor to fix scrollbar flicker ([#1891](https://github.com/JasonBuildAI/deepagents/issues/1891)) ([a9be236](https://github.com/JasonBuildAI/deepagents/commit/a9be2368509f9f2c66537014ae2138253cf0dc39))
* **cli:** resolve config-defined providers during runtime model swaps ([#1941](https://github.com/JasonBuildAI/deepagents/issues/1941)) ([aebc660](https://github.com/JasonBuildAI/deepagents/commit/aebc660321895909f6b6eb71e72a99ca7754bcf1))
* **cli:** resolve conflicting langsmith env var precedence ([#2455](https://github.com/JasonBuildAI/deepagents/issues/2455)) ([b6997d8](https://github.com/JasonBuildAI/deepagents/commit/b6997d830c8c2822acbaa0ad672bdec873af2b9d))
* **cli:** show checkmark for `class_path` providers in model selector ([#1899](https://github.com/JasonBuildAI/deepagents/issues/1899)) ([4adb712](https://github.com/JasonBuildAI/deepagents/commit/4adb712c8eacbcfbc06801c31bfd74fc0705bed3))
* **cli:** show server startup error instead of generic agent message ([#2397](https://github.com/JasonBuildAI/deepagents/issues/2397)) ([a3e1e93](https://github.com/JasonBuildAI/deepagents/commit/a3e1e9365178ad14d7233ae577bb87d714daff5c))
* **cli:** slash commands should not require server connection / queue ([#1974](https://github.com/JasonBuildAI/deepagents/issues/1974)) ([32bd814](https://github.com/JasonBuildAI/deepagents/commit/32bd814b98a079778dad092a2e877d8eba22b0fb))
* **cli:** sort MCP tools deterministically for prompt-cache stability ([#2497](https://github.com/JasonBuildAI/deepagents/issues/2497)) ([39b43cf](https://github.com/JasonBuildAI/deepagents/commit/39b43cf8d0f44827f3b2faf32843c7db436539e8))
* **cli:** sort prefetched threads by user preference on initial render ([#1806](https://github.com/JasonBuildAI/deepagents/issues/1806)) ([6f71153](https://github.com/JasonBuildAI/deepagents/commit/6f711532976821a92e3396fe458ec7874b1237ef))
* **cli:** stop loading widget timer leak ([#2396](https://github.com/JasonBuildAI/deepagents/issues/2396)) ([01d3d86](https://github.com/JasonBuildAI/deepagents/commit/01d3d864098c4e96527082b2bd1755ac6591b098))
* **cli:** support pre-release versions in update checker ([#2164](https://github.com/JasonBuildAI/deepagents/issues/2164)) ([e18e9dc](https://github.com/JasonBuildAI/deepagents/commit/e18e9dcd0e6edc72c0a4a5b76ae752c4bc539752))
* **cli:** surface clear error for missing sandbox provider deps ([#1999](https://github.com/JasonBuildAI/deepagents/issues/1999)) ([939f56a](https://github.com/JasonBuildAI/deepagents/commit/939f56a19244714fc53158a2fd162e3098b3d56c))
* **cli:** use `max-height` for `tool-info-scroll` to shrink-wrap content ([#1835](https://github.com/JasonBuildAI/deepagents/issues/1835)) ([a4e1908](https://github.com/JasonBuildAI/deepagents/commit/a4e1908527c3a30a6f967dd1d989739d540ddd2a))
* **cli:** use ascii-safe glyphs in tool status restore path ([#1895](https://github.com/JasonBuildAI/deepagents/issues/1895)) ([2a9cbc8](https://github.com/JasonBuildAI/deepagents/commit/2a9cbc8540b2ab77362cbb00764a3533e234891f))
* **cli:** use counter to close history-recall autocomplete race ([#1901](https://github.com/JasonBuildAI/deepagents/issues/1901)) ([bfd08af](https://github.com/JasonBuildAI/deepagents/commit/bfd08afbc0eca844e565842dff50eddb067e4750))
* **cli:** use relative paths in langgraph config for Windows compat ([#2244](https://github.com/JasonBuildAI/deepagents/issues/2244)) ([d10dfbd](https://github.com/JasonBuildAI/deepagents/commit/d10dfbd7d8ff18653d0d25197c76c8b379f60bf0))
* **cli:** use UUID7 for thread IDs instead of 8-char hex ([#1826](https://github.com/JasonBuildAI/deepagents/issues/1826)) ([821885b](https://github.com/JasonBuildAI/deepagents/commit/821885bab8ae2eef873a33fdaa6dc427a473d764))
* **cli:** warn agent that local filesystem is inaccessible in sandbox mode ([#2274](https://github.com/JasonBuildAI/deepagents/issues/2274)) ([a3b61e5](https://github.com/JasonBuildAI/deepagents/commit/a3b61e5d57fcf240fec4afa7734a5c864bdcd886))
* **cli:** wire `enable_ask_user` flag to remove tool in non-interactive mode ([#2105](https://github.com/JasonBuildAI/deepagents/issues/2105)) ([2399747](https://github.com/JasonBuildAI/deepagents/commit/23997478c006728fc3923e1e8853626794319c32))
* **cli:** work around VS Code 1.110 space key regression ([#1748](https://github.com/JasonBuildAI/deepagents/issues/1748)) ([f5fe431](https://github.com/JasonBuildAI/deepagents/commit/f5fe4315143bf5b636cf42fc98cbfe3d99918cfc))
* **sdk,cli:** align error messages and clean up recent refactors ([#2171](https://github.com/JasonBuildAI/deepagents/issues/2171)) ([e2db737](https://github.com/JasonBuildAI/deepagents/commit/e2db73779926e1effd6d227e14b137b93393461e))
* **sdk:** use file transfer instead of command strings for sandbox write/edit ([#2117](https://github.com/JasonBuildAI/deepagents/issues/2117)) ([6c2d559](https://github.com/JasonBuildAI/deepagents/commit/6c2d559b574a5a5d9de3adc36d6cf02d6cf93d9d)), closes [#1402](https://github.com/JasonBuildAI/deepagents/issues/1402)


### Performance Improvements

* **cli:** add textual-speedups for Rust-based layout primitives ([#1910](https://github.com/JasonBuildAI/deepagents/issues/1910)) ([45b58a1](https://github.com/JasonBuildAI/deepagents/commit/45b58a13e14abfb58ef3688cee51a5819d8ca52d))
* **cli:** defer `/model` selector data loading off event loop ([#2259](https://github.com/JasonBuildAI/deepagents/issues/2259)) ([a32ce7f](https://github.com/JasonBuildAI/deepagents/commit/a32ce7ff6b2112cf48170d2279a1953eded61987))
* **cli:** defer heavy imports from startup path ([#2022](https://github.com/JasonBuildAI/deepagents/issues/2022)) ([b7f5a99](https://github.com/JasonBuildAI/deepagents/commit/b7f5a99ecda2e3b795764e74bc1e9cbc405b7e18))
* **cli:** defer pydantic and adapter imports out of startup hot path ([#2269](https://github.com/JasonBuildAI/deepagents/issues/2269)) ([0a410b4](https://github.com/JasonBuildAI/deepagents/commit/0a410b4aba729a71c78e7fd470c904d95fea171a))
* **cli:** offload blocking path ops from textual event loop ([#1894](https://github.com/JasonBuildAI/deepagents/issues/1894)) ([d3eedcc](https://github.com/JasonBuildAI/deepagents/commit/d3eedccc7edd21103ca1e586fc365d721f674099))
* **cli:** prewarm markdown stack and cache skill body render ([#2236](https://github.com/JasonBuildAI/deepagents/issues/2236)) ([0a3ba47](https://github.com/JasonBuildAI/deepagents/commit/0a3ba47615bfdaba1a51dbff1c75c392dd87579e))
* **cli:** reduce health poll interval for local langgraph dev server ([#2283](https://github.com/JasonBuildAI/deepagents/issues/2283)) ([7f5c3de](https://github.com/JasonBuildAI/deepagents/commit/7f5c3de9cf5501abc24fbaf50152c4c625b04f1b))
* **cli:** speed up `/model` selector with cache pre-warming and async saves ([#1813](https://github.com/JasonBuildAI/deepagents/issues/1813)) ([2aec75c](https://github.com/JasonBuildAI/deepagents/commit/2aec75c8dca6c0510671cf1288a924c4ca9bce1c))
* **cli:** speed up `/threads` modal startup ([#1811](https://github.com/JasonBuildAI/deepagents/issues/1811)) ([5758df1](https://github.com/JasonBuildAI/deepagents/commit/5758df1b663cd09726b8cd08d86897351142ed5e))
* **cli:** speed up unit tests in CI ([#1817](https://github.com/JasonBuildAI/deepagents/issues/1817)) ([59b1b5c](https://github.com/JasonBuildAI/deepagents/commit/59b1b5cb720a309434d7e863d2e45e83f8ac1432))
* **cli:** sub 250ms first paint ([#2027](https://github.com/JasonBuildAI/deepagents/issues/2027)) ([e42e05c](https://github.com/JasonBuildAI/deepagents/commit/e42e05c12229ece450746d6f943d2483477518a5))
* **cli:** use stream layout for messages container ([#1896](https://github.com/JasonBuildAI/deepagents/issues/1896)) ([b35401b](https://github.com/JasonBuildAI/deepagents/commit/b35401b885a7651db548f1826ddb24476ecde5b7))


### Reverted Changes

* make summarization test compatible with sdk 0.4.11 ([#1923](https://github.com/JasonBuildAI/deepagents/issues/1923)) ([22fd479](https://github.com/JasonBuildAI/deepagents/commit/22fd4793196f3b2493ed155330ec325302b6e960))
